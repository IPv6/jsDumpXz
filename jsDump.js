...
function coalesceInt(e,def){if(!def){def = 0;};if(!e){return def;};return parseInt(e);};
function roundToPrecision(inputNum, desiredPrecision){var precisionGuide = Math.pow(10, desiredPrecision);return( Math.round(inputNum * precisionGuide) / precisionGuide );}
